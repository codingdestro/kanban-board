...
interface SidebarProps {
  activeView: 'board' | 'list' | 'analytics' | 'calendar';
  setActiveView: (view: 'board' | 'list' | 'analytics' | 'calendar') => void;
}

export default function WorkspaceSidebar({ activeView, setActiveView }: SidebarProps) {
          ...
          {!isCollapsed && (
            <div className="flex items-center gap-2">
              ...
              <div className="flex flex-col">
                <span className="font-bold text-xs leading-none">DEVFLOW</span>
                <span className="text-[8px] text-muted-foreground font-mono mt-0.5 tracking-wider">DESKTOP v0.1</span>
              </div>
            </div>
          )}
