...
export default function WorkspaceHeader() {
  ...
  return (
    <header className="border-b border-border bg-background/50 backdrop-blur-md sticky top-0 z-20 px-6 py-4 flex flex-col md:flex-row md:items-center justify-between gap-4 [-webkit-app-region:drag] select-none">
      {/* Board Selector & Title */}
      <div className="flex items-center gap-3 relative [-webkit-app-region:no-drag]">
      ...
      <div className="flex flex-wrap items-center gap-3 [-webkit-app-region:no-drag]">
        {/* Search Input */}
