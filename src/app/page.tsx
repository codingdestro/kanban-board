...
export default function Home() {
  ...
  if (!isHydrated) {
    return (
      <div className="flex min-h-screen items-center justify-center bg-slate-950 text-slate-200 select-none">
  ...
  return (
    <div className="bg-background text-foreground flex min-h-screen transition-colors duration-300">
      {/* Navigation Sidebar */}
      <WorkspaceSidebar />
